...
contract CommonToken is StandardToken, MultiOwnable {
    ...
    string public constant name   = 'Dapp Starter Token';
    string public constant symbol = 'DST';
    uint8 public constant decimals = 18;
    
    uint256 public saleLimit;   // 85% of tokens for sale.
    uint256 public teamTokens;  // 15% of tokens goes to the team and will be locked for 1 year.
    
    // 15% of team tokens will be locked at this address for 1 year.
    ...
    function CommonToken(
        ...
        saleLimit   =  85000000 ether;
        teamTokens  =  15000000 ether;
